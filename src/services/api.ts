...
import {
	AppAction, requestLogout, requestServlets, respondCatalog, respondCheckUser,
	respondLogin, respondServlets, TypeKeys
} from "../actions"
...
import {
	respondChange, respondCreate, respondDelete, respondDetails, respondList,
