...
export function respondCollections(collections: SubjectCollection[]): CollectionsListResponseAction {
	return {
		type: TypeKeys.COLLECTIONS_LIST_RESPONSE,
...
export function requestSubjects(collection: SubjectCollection): SubjectsListRequestAction {
	return {
		type: TypeKeys.SUBJECTS_LIST_REQUEST,
...
export function respondSubjects(collection: SubjectCollection, subjects: Subject[]): SubjectsListResponseAction {
	return {
		type: TypeKeys.SUBJECTS_LIST_RESPONSE,
		collection: collection,
		subjects: subjects,
...
export type PermissionAction = CollectionsListRequestAction | CollectionsListResponseAction |
	SubjectsListRequestAction | SubjectsListResponseAction
